        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li><a href={appendUtmParams("https://mystylus.ai/terms-conditions/")} className="text-[#232323] hover:opacity-70 font-aeonik">Termos de serviço</a></li>
              ...
              <li><a href={appendUtmParams("https://mystylus.ai/about-us/")} className="text-[#232323] hover:opacity-70 font-aeonik">Sobre nós</a></li>
          ...
          {/* AI Generators */}
          <div>
            <h3 className="font-medium mb-3 sm:mb-4 font-aeonik text-base sm:text-lg">Geradores de IA</h3>
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li><a href={appendUtmParams("https://mystylus.ai/ai-paper-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Gerador de Artigos Científicos</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li><a href={appendUtmParams("https://mystylus.ai/ai-essay-writer/")} className="text-[#232323] hover:opacity-70 font-aeonik">Assistente de Escrita por IA</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/essay-title-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Gerador de Títulos de Ensaio</a></li>
              ...
              <li><a href={appendUtmParams("https://mystylus.ai/ai-literature-review-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Gerador de Revisão de Literatura</a></li>
            </ul>
          </div>

          {/* Follow Us */}
          <div>
            <h3 className="font-medium mb-3 sm:mb-4 font-aeonik text-base sm:text-lg">Siga-nos</h3>
