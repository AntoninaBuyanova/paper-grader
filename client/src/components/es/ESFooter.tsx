        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              <li><a href={appendUtmParams("https://mystylus.ai/terms-conditions/")} className="text-[#232323] hover:opacity-70 font-aeonik">Términos de servicio</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/privacy-policy/")} className="text-[#232323] hover:opacity-70 font-aeonik">Política de cookies y privacidad</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/about-us/")} className="text-[#232323] hover:opacity-70 font-aeonik">Sobre nosotros</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li><a href={appendUtmParams("https://mystylus.ai/thesis-statement-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Generador de tesis: Prueba uno</a></li>
            </ul>
          </div>
