    ...
    <footer className="py-12 sm:py-16 md:py-20 bg-[#F8F8F3] font-aeonik">
      <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 xs:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-12 sm:mb-16">
          {/* Company */}
          <div>
            <h3 className="font-medium mb-3 sm:mb-4 font-aeonik text-base sm:text-lg">Company</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li><a href={appendUtmParams("https://mystylus.ai/terms-conditions/")} className="text-[#232323] hover:opacity-70 font-aeonik">Terms of service</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/privacy-policy/")} className="text-[#232323] hover:opacity-70 font-aeonik">Cookie & Privacy policy</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/about-us/")} className="text-[#232323] hover:opacity-70 font-aeonik">About us</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/affiliate-program/")} className="text-[#232323] hover:opacity-70 font-aeonik">Affiliate Program</a></li>
            </ul>
          </div>

          {/* AI Generators */}
          <div>
            <h3 className="font-medium mb-3 sm:mb-4 font-aeonik text-base sm:text-lg">AI Generators</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li><a href={appendUtmParams("https://mystylus.ai/paragraph-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Paragraph Generator</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/ai-paper-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Research Paper Generator</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/ai-story-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Story Generator</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/thesis-statement-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Thesis Generator: Try one</a></li>
            </ul>
          </div>

          {/* Writing tools */}
          <div>
            <h3 className="font-medium mb-3 sm:mb-4 font-aeonik text-base sm:text-lg">Writing tools</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li><a href={appendUtmParams("https://mystylus.ai/ai-essay-writer/")} className="text-[#232323] hover:opacity-70 font-aeonik">AI Writing Assistant</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/essay-title-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Essay Title Generator</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/paraphrase-tool/")} className="text-[#232323] hover:opacity-70 font-aeonik">Paraphraser Tool</a></li>
              <li><a href={appendUtmParams("https://mystylus.ai/ai-literature-review-generator/")} className="text-[#232323] hover:opacity-70 font-aeonik">Literature Review Generator</a></li>
            </ul>
          </div>

          {/* Follow Us */}
          <div>
            <h3 className="font-medium mb-3 sm:mb-4 font-aeonik text-base sm:text-lg">Follow Us</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 sm:gap-8 md:gap-12 text-xs sm:text-sm text-[#232323] font-aeonik">
          <div className="flex flex-col gap-1 mb-4 md:mb-0">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <a href={appendUtmParams("https://mystylus.ai/privacy-policy/")} className="hover:opacity-70 font-medium">Privacy policy</a>
            </div>
          </div>
